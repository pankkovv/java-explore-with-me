DROP TABLE IF EXISTS events, categories, locations, users, requests, compilations, compilations_events, subscriptions_users, subscribers_users CASCADE;
...
(
    ...
    subscription_permission BOOLEAN                              NOT NULL,
...
CREATE TABLE IF NOT EXISTS subscribers_users
(
    users_id        INT NOT NULL,
